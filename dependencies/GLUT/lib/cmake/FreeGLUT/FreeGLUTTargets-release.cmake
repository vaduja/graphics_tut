...
set_target_properties(FreeGLUT::freeglut PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libglut.3.11.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libglut.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS FreeGLUT::freeglut )
list(APPEND _IMPORT_CHECK_FILES_FOR_FreeGLUT::freeglut "${_IMPORT_PREFIX}/lib/libglut.3.11.1.dylib" )
